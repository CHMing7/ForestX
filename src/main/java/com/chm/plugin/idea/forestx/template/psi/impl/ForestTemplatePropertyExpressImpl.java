...
public class ForestTemplatePropertyExpressImpl extends ASTWrapperPsiElement implements ForestTemplatePropertyExpress {

  public ForestTemplatePropertyExpressImpl(@NotNull ASTNode node) {
    super(node);
  }
