...
public class ForestTemplateDecimalImpl extends ASTWrapperPsiElement implements ForestTemplateDecimal {

  public ForestTemplateDecimalImpl(@NotNull ASTNode node) {
    super(node);
  }
