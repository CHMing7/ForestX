...
public class ForestTemplatePropertyArrayIndexImpl extends ASTWrapperPsiElement implements ForestTemplatePropertyArrayIndex {

  public ForestTemplatePropertyArrayIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ForestTemplateVisitor visitor) {
    visitor.visitPropertyArrayIndex(this);
  }
